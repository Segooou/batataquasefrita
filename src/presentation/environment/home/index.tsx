  ...
  return (
    <div>
      <div className={'flex flex-col gap-2'}>
        ...
        <DraggableContainer height={120}>
          {aaa.map((item) => {
            return (
              <div
                key={item}
                className={
                  'min-w-[200px] bg-gray-800 border border-gray-550 rounded-md h-[100px] bg-blue-500 flex items-center justify-center text-white'
                }
                onClick={(event): void => {
